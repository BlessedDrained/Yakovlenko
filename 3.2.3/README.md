По непонятной мне причине время работы метода get_multiprocess_statistics(), для которого, собственно, и приведены эталонные значения времени выполнения на elearn, не указано в графе.
